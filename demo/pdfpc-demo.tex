...
\begin{frame}
  ...
  \begin{itemize}
    \item Pressing \keys{G} you can enter a slide number to jump to
      \singleitem{To come back to this slide you can use the
        \keys{\shift+\backspace} combination or remember that we are on slide
        \insertframenumber.}
    \item Pressing \keys{\tab} (Tab) you get an overview of the whole
      presentation, which you can use to jump around
  ...
  \begin{itemize}
    ...
    \item Pressing \keys{\ctrl+E} you can define this to be the end slide
      ...
      \singleitem{It also updates the slide you jump to when pressing
        \keys{End}}
    \item For exiting, press \keys{\ctrl+Q}
  \end{itemize}
  \vfill
  \begin{center}
    THE END
